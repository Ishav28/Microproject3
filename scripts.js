...
function getallvegetables(){
   let newarr= foodoriginaldata.filter((a)=>{
...
function getallfruits(){
 ...
 function getallprotiens(){
    let newarr=foodoriginaldata.filter((a)=>{
  return a.protiens>1 && a.protiens<10 ;
    })
    console.log(newarr);
 }
...
function getalldiary(){
 ...
 function getallcaloriesabove100(){
    let newarr= foodoriginaldata.filter((a)=>{
 ...
 function getallcaloriesless100(){
    let newarr= foodoriginaldata.filter((a)=>{
     return a.calorie<=100;
    })
    console.log(newarr);
...
function highestprotien(){
 let newarr= foodoriginaldata.sort((a,b)=>{
